...
import com.example.niceapp.onboarding.GettingStartedActivity
...
class AuthenticationActivity : AppCompatActivity() {
    ...
    val RC_SIGN_IN = 123
    lateinit var editEmailIn:EditText
    lateinit var editPasswordIn:EditText
