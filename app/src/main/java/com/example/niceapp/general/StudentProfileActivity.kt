package com.example.niceapp.general
                    ...
                    for (ds in dataSnapshot.children) {
                        ...
                        if (studentData != null) {
                            ...
                            if(count.size == 1) {
                                ...
                                profileTextLayout.findViewById<TextView>(R.id.profileText).text = "${(firstName?.get(0))}${
                            ...
                            profileTextLayout.findViewById<TextView>(R.id.editProfile).setOnClickListener {
                                ...
                                editStudentName.visibility = View.VISIBLE
                                ...
                                editPhoneNumber.visibility = View.VISIBLE
                            ...
                            saveProfile.setOnClickListener {
                                ...
                                if(studentName.isEmpty()) {
                                    editStudentName.error = "Please enter Student Name"
                                } else if(phoneNumber.isEmpty() and phoneNumber.length) {
                                    editStudentName.error = null
                                    editPhoneNumber.error = "Please enter Valid Phone Number"
                                } else {
                                    ...
                                    editStudentName.visibility = View.GONE
