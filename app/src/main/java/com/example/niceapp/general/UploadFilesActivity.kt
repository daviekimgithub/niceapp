    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        publishFile.setOnClickListener{
            ...
            if(fileSelected.equals("0")) {
                ...
                editFileTitle.error = "Please enter Title for File"
            } else if(isNullOrEmpty(subjectName)) {
                editFileTitle.error = null
                subjectNameSpinner.error = "Please select related Subject"
            } else if(unitNumber?.let { it1 -> isNullOrEmpty(it1) }!!) {
                subjectNameSpinner.error = null
                editFileTitle.error = null
                ...
                editFileTitle.isEnabled = false
                subjectNameSpinner.isEnabled = false
